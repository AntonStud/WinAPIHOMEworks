...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE: 
		...
		//Edit_SetCueBannerText(ctrls[EDITBOX], "Введите строку для поиска");
		//Edit_SetCueBannerTextFocused(ctrls[EDITBOX], "Введите строку для поиска",TRUE);

		SendMessage(ctrls[EDITBOX], EM_SETCUEBANNER, TRUE, (LPARAM)L"Введите строку для поиска...");
